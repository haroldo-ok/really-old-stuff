...
;==============================================================
.sdsctag 1.10,"Backword","Backword VM","Haroldo O. Pinheiro"
...
InitializeBackwordVM:
    ;==============================================================
    ; Initializes backword VM
    ;==============================================================   
    ld ix, BACKWORD_BOOT
    ld iy, backwordStackBase
